...
(() => {
  ...
  // node_modules/.pnpm/chartjs-plugin-deferred@2.0.0_chart.js@4.4.2/node_modules/chartjs-plugin-deferred/dist/chartjs-plugin-deferred.esm.js
  ...
  // src/index.ts
  var familyEnergyData = [
    {
      familySize: "Singlehaushalt",
      eigennutzung: 98,
      // Example value in percentage
      autarkie: 16,
      // Example value in percentage
      gesamterzeugung: 370,
      // Total production in kWp
      gesamtbedarf: 2500,
      // Total demand in kWh
      module: 1,
      preis: 1099
  ...
  window.Webflow.push(() => {
    ...
    const ctx = document.getElementById("autarkie")?.getContext("2d");
    const myChart = new auto_default(ctx, config);
    console.log(config);
    ...
    const ctxEigennutzung = document.getElementById("Eigennutzung")?.getContext("2d");
    const myChartEigennutzung = new auto_default(ctxEigennutzung, configEigennutzung);
    console.log(configEigennutzung);
    const dataBarChart = {
      labels: ["Gesamterzeugung", "Gesamtbedarf"],
      datasets: [
        {
          data: [gesamterzeugung, gesamtbedarf],
          // Example values in kWh for Gesamterzeugung and Gesamtbedarf
          backgroundColor: ["#079561", "#F0F4F2"],
          barPercentage: 0.6,
    ...
    const myBarChart = new auto_default(ctxBarChart, configBarChart);
    console.log(configBarChart);
    sizeInputs.forEach((sizeInput) => {
      sizeInput.addEventListener("change", () => {
        size = sizeInput.value;
        familyEnergy = familyEnergyData.find((data2) => data2.familySize === size);
        ({ eigennutzung, autarkie, gesamterzeugung, gesamtbedarf } = familyEnergy);
...
chartjs-plugin-deferred/dist/chartjs-plugin-deferred.esm.js:
  (*!
